...
export const TUTORIAL_STEPS: TutorialStepConfig[] = [
  {
    ...
    title: 'プロフィール画面への移動',
    description: '画面下部のメニューにあるプロフィールアイコンをタップして、プロフィール画面へ移動します。',
    pointerDirection: 'down',
    actionPrompt: 'プロフィールアイコンをタップ',
  },
  {
    id: 2,
    selector: '[data-tutorial-id="tutorial-profile-edit"]',
    tabRequirement: 'profile',
    title: '登録情報の変更',
    description: '氏名、ニックネーム、所属大学、学年などの登録情報は、この画面からいつでも変更・保存できます。',
    pointerDirection: 'up',
    actionPrompt: '次へ進む',
  },
  {
    id: 3,
    selector: '[data-tutorial-id="tutorial-sns-section"]',
    tabRequirement: 'profile',
    title: 'SNSリンクの追加',
    description: '画面を下へスクロールすると、XやGitHubなどのSNSリンクを追加できます。名刺やフレンド交換に反映されます。',
    pointerDirection: 'up',
    actionPrompt: 'チュートリアルを完了する',
  },
];
